...
if (isset($_GET['action']) && $_GET['action']=="stations") {
  ...
  $station = file_get_contents('http://localhost/web_api/api.php?action=stations');
...
if (isset($_GET['rypos']) && isset($_GET['kwdikos']) && isset($_GET['date']) && isset($_GET['wra'])) {
  ...
  $absolute = file_get_contents("http://localhost/web_api/api.php?action=abs_rypos&rypos=".$_GET['rypos']."&kwdikos=".$_GET['kwdikos']."&hmeromhnia=".$_GET['date']."&wra=".$_GET['wra']);
...
<?php
  ...
  $average = file_get_contents("http://localhost/web_api/api.php?action=average&rypos=".$_GET['rypos']."&kwdikos=".$_GET['kwdikos']."&hmeromhnia=".$_GET['date']);
